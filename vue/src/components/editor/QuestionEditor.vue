    ...
    <div>
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-bold">
                ...
                <div class="flex items-center my-3">
                    ...
                    <button type="button" @click="deleteQuestion()" class="flex items-center text-xs py-1 px-3 rounde-md border border-transparent text-red-500 hover:border-red-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="grid gap-3 grid-cols-12">
            ...
            <div class="mt-3 col-span-3">
                <label for="question_type" class="block text-sm font-medium text-gray-700">Select a Question Type</label>
                <select name="question_type" id="question_type" v-model="model.type" @change="typeChange" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-sm shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="mt-3 col-span-9">
            ...
            <textarea :name="'question_description_' + model.id" v-model="model.description" @change="dataChange" id="question_description_" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"></textarea>
        </div>
        ...
        <div v-if="shouldHaveOptions()" class="mt-2">
            <h4 class="text-sm font-semibold mb-1 flex justify-between items-center">
                ...
                <!-- Add New Option Button Ends Here -->
            </h4>
            ...
            <div v-for="(option, index) in model.data.options" :key="option.uuid" class="flex items-center mb-1">
                ...
                <!-- Delete Option -->
                    <button type="button" @click="removeOption(option)" class="flex items-center text-xs py-1 px-3 rounde-md border border-transparent text-red-500">
